...
CControls Controls[NUM_CONTROL_ACTIONS] = {
    { "PED_FIREWEAPON", MOUSE(rsMOUSELEFTBUTTON), GAMEPAD_CIRCLE, GAMEPAD_RIGHTSHOULDER2 },
    { "PED_FIREWEAPON_ALT", KEY(rsNULL), GAMEPAD_LEFTSHOULDER1, GAMEPAD_CROSS },
    { "PED_CYCLE_WEAPON_RIGHT", MOUSE(rsMOUSEWHEELDOWNBUTTON), GAMEPAD_RIGHTSHOULDER2, GAMEPAD_DPADRIGHT },
    { "PED_CYCLE_WEAPON_LEFT", MOUSE(rsMOUSEWHEELUPBUTTON), GAMEPAD_LEFTSHOULDER2, GAMEPAD_DPADLEFT },
    { "GO_FORWARD", KEY('W'), GAMEPAD_THUMBLYU, GAMEPAD_THUMBLYU },
    { "GO_BACK", KEY('S'), GAMEPAD_THUMBLYD, GAMEPAD_THUMBLYD },
    { "GO_LEFT", KEY('A'), GAMEPAD_THUMBLXL, GAMEPAD_THUMBLXL },
    { "GO_RIGHT", KEY('D'), GAMEPAD_THUMBLXR, GAMEPAD_THUMBLXR },
    { "PED_SNIPER_ZOOM_IN", MOUSE(rsMOUSEWHEELUPBUTTON), GAMEPAD_LEFTSHOULDER2, GAMEPAD_THUMBLYU },
    { "PED_SNIPER_ZOOM_OUT", MOUSE(rsMOUSEWHEELDOWNBUTTON), GAMEPAD_RIGHTSHOULDER2, GAMEPAD_THUMBLYD },
    { "VEHICLE_ENTER_EXIT", KEY('F'), GAMEPAD_TRIANGLE, GAMEPAD_TRIANGLE },
    { "CAMERA_CHANGE_VIEW_ALL_SITUATIONS", KEY('V'), GAMEPAD_SELECT, GAMEPAD_SELECT },
    { "PED_JUMPING", rsSPACE, GAMEPAD_SQUARE, GAMEPAD_SQUARE },
    { "PED_SPRINT", KEY(rsLSHIFT), GAMEPAD_CROSS, GAMEPAD_CROSS },
    { "PED_LOOKBEHIND", KEY('C'), GAMEPAD_THUMBR, GAMEPAD_THUMBR },
    { "PED_DUCK", KEY(rsLCTRL), GAMEPAD_THUMBL, GAMEPAD_THUMBL },
    ...
    { "VEHICLE_STEERDOWN", KEY(rsPGDN), GAMEPAD_THUMBLYD },
    { "VEHICLE_ACCELERATE", KEY('W'), GAMEPAD_CROSS, GAMEPAD_RIGHTSHOULDER2 },
    { "VEHICLE_BRAKE", KEY('S'), GAMEPAD_SQUARE, GAMEPAD_LEFTSHOULDER2 },
    { "VEHICLE_RADIO_STATION_UP", MOUSE(rsMOUSEWHEELUPBUTTON), GAMEPAD_NONE },
    { "VEHICLE_RADIO_STATION_DOWN", MOUSE(rsMOUSEWHEELDOWNBUTTON), GAMEPAD_DPADLEFT, GAMEPAD_DPADLEFT },
    { "UNKNOWN_1", KEY(rsNULL), GAMEPAD_NONE, GAMEPAD_NONE },
    { "VEHICLE_HORN", KEY(rsLSHIFT), GAMEPAD_THUMBL, GAMEPAD_THUMBL },
    { "TOGGLE_SUBMISSIONS", KEY(rsLCTRL), GAMEPAD_THUMBR, GAMEPAD_THUMBR },
    { "VEHICLE_HANDBRAKE", KEY(rsSPACE), GAMEPAD_RIGHTSHOULDER1, GAMEPAD_CROSS },
    { "PED_1RST_PERSON_LOOK_LEFT", KEY('Q'), GAMEPAD_THUMBRXL, GAMEPAD_THUMBRXL },
    { "PED_1RST_PERSON_LOOK_RIGHT", KEY('E'), GAMEPAD_THUMBRXR, GAMEPAD_THUMBRXR },
    { "VEHICLE_LOOKLEFT", KEY('Q'), GAMEPAD_THUMBRXL, GAMEPAD_THUMBRXL },
    ...
    { "PED_LOCK_TARGET", MOUSE(rsMOUSERIGHTBUTTON), GAMEPAD_RIGHTSHOULDER1, GAMEPAD_LEFTSHOULDER2 },
    { "NETWORK_TALK", KEY(rsNULL), GAMEPAD_NONE, GAMEPAD_NONE },
    { "CONVERSATION_YES", KEY('Y'), GAMEPAD_DPADRIGHT, GAMEPAD_DPADUP },
    { "CONVERSATION_NO", KEY('N'), GAMEPAD_DPADLEFT, GAMEPAD_DPADDOWN },
    { "GROUP_CONTROL_FWD", KEY('Y'), GAMEPAD_DPADUP, GAMEPAD_DPADUP },
    { "GROUP_CONTROL_BWD", KEY('N'), GAMEPAD_DPADDOWN, GAMEPAD_DPADDOWN },
    { "PED_1RST_PERSON_LOOK_UP", KEY(rsNULL), GAMEPAD_THUMBRYU, GAMEPAD_THUMBRYU },
    { "PED_1RST_PERSON_LOOK_DOWN", KEY(rsNULL), GAMEPAD_THUMBRYD, GAMEPAD_THUMBRYD },
    { "UNKNOWN_2", KEY(rsNULL), GAMEPAD_NONE, GAMEPAD_NONE },
    { "TOGGLE_DPAD", KEY(rsNULL), GAMEPAD_NONE, GAMEPAD_NONE },
    { "SWITCH_DEBUG_CAM_ON", KEY(rsNULL), GAMEPAD_NONE, GAMEPAD_NONE },
    { "TAKE_SCREEN_SHOT", KEY(rsNULL), GAMEPAD_NONE, GAMEPAD_NONE },
    { "SHOW_MOUSE_POINTER_TOGGLE", KEY(rsNULL), GAMEPAD_NONE, GAMEPAD_NONE },
    { "SHOW_WEAPON_WHEEL", KEY(rsTAB), GAMEPAD_LEFTSHOULDER1, GAMEPAD_LEFTSHOULDER1 },
    { "EXTEND_RADAR_RANGE", KEY('Z'), GAMEPAD_DPADDOWN, GAMEPAD_DPADDOWN },
    { "SHOW_PLAYER_STATS", KEY(rsLALT), GAMEPAD_DPADDOWN, GAMEPAD_DPADDOWN },
    { "PHONE_SHOW", MOUSE(rsMOUSEMIDDLEBUTTON), GAMEPAD_DPADUP, GAMEPAD_DPADUP },
    { "PHONE_HIDE", MOUSE(rsMOUSERIGHTBUTTON), GAMEPAD_CIRCLE, GAMEPAD_CIRCLE },
    { "PHONE_UP", KEY(rsUP), GAMEPAD_DPADUP, GAMEPAD_DPADUP },
    { "PHONE_DOWN", KEY(rsDOWN), GAMEPAD_DPADDOWN, GAMEPAD_DPADDOWN },
    { "PHONE_LEFT", MOUSE(rsMOUSEWHEELUPBUTTON), GAMEPAD_DPADLEFT, GAMEPAD_DPADLEFT },
    { "PHONE_RIGHT", MOUSE(rsMOUSEWHEELDOWNBUTTON), GAMEPAD_DPADRIGHT, GAMEPAD_DPADRIGHT },
    { "PHONE_ENTER", MOUSE(rsMOUSELEFTBUTTON), GAMEPAD_CROSS, GAMEPAD_CROSS },
    { "MENU_SHOW_HIDE_LEGEND", KEY('L'), GAMEPAD_SQUARE, GAMEPAD_SQUARE },
    { "MENU_PLACE_WAYPOINT", KEY(rsENTER), GAMEPAD_CROSS, GAMEPAD_CROSS },
    { "MENU_DELETE_SAVE", KEY(' '), GAMEPAD_SQUARE, GAMEPAD_SQUARE },
